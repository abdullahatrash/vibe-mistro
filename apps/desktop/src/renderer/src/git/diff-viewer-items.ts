 ...
 * The content fold reuses `patch-cache-key`'s FNV-1a (#389) — one hash module, two
 * consumers (parse cache keys there, item versions here).
 */

import { fnv1a32 } from './patch-cache-key'
